...
| # | Item | Status | Notes |
|---|------|--------|-------|
| _(none)_ | — | — | No active items. Recently completed: G2 (Merged Translate-or-Fix), G1 (Fix Grammar), R1 (cache + Re-translate), R2 (Custom Prompt + bug fix) — see `ROADMAP_DONE.md`. |
