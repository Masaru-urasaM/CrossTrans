...
- **F0–F7 — Furigana everywhere** — hiragana readings above kanji on every surface that can show
  ...
  tests. See Decision 8 — ✅ Done (2026-08-17) [1.9.19]
- **Rename** — storage identity aligned to CrossTrans (config dir, model cache, autostart registry key, DPAPI entropy); clean rename, no migration — breaking change: existing users re-enter API keys + manually clear the old autostart entry. See Decision 7 — ✅ Done (2026-07-02) [1.9.19]
