...
class GuideTabMixin:
    ...
    def _create_guide_tab(self, parent):
        ...
        self._create_guide_section(guide_container, "Hotkeys", [
            ...
            "",
            "Fix Grammar:",
            "  \u2022 Win + Alt + G  \u2192  Correct grammar of selected text (no translation, same language)",
            "    (If Xbox Game Bar uses Win+Alt+G, rebind it in Settings \u2192 Hotkeys or use the button.)",
            "",
            "Custom Hotkeys:",
